<div id="footer" class="navbar center">
	<div class="navbar-inner">
		<ul class="nav">
			<li><a id="activate-contact-modal" name="contact-modal" href="#" onclick="showModal('contact-modal');">Contact Us</a></li>
	...
	// Use the AYAH object to get the score.
        ...
        if ($score) {
        	...
        	if(isset($_POST['email']) && isset($_POST['message'])) {
        		...
        		mail('slackline@listserv.brown.edu', $subject, $_POST['message'], $headers);
        	}	
        }
}?>
<div id="mask" class="modal-utilities" onclick="closeModal();"></div>
<div id="contact-modal" class="modal-utilities well center-text">
